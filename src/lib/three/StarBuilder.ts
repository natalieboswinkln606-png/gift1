...
import { BLOOM_LAYER } from './ParticleSystem'
...
export class StarBuilder {
  ...
  update(time: number, isTree: boolean, treeHeight: number): void {
    ...
    this.mesh.scale.setScalar(THREE.MathUtils.lerp(this.mesh.scale.x, isTree ? 1.0 : 0.01, 0.1))
  }
